...
def main(session):
    ...
    vid_recorder_service.setFrameRate(15)
    vid_recorder_service.setCameraID(1)
    vid_recorder_service.setVideoFormat("MJPG")
    vid_recorder_service.setColorSpace(0)
    ...
    while True:
	    ...
	    vid_recorder_service.setCameraID(0)
            vid_recorder_service.startRecording("/home/nao/recordings/cameras", "myvideoCameraTop")
            print "Change camera "
            break
